...
const FONT_SIZE_SELECTOR = 'h1,h2,h3,h4,h5,h6,p,a,dl,dt,li,ol,th,td,span,blockquote,.visua11y-agent-text';
...
export default function adjustFontSize(multiply:number = 1) {
    document
        ...
        .forEach((el: HTMLElement) => {
            ...
            const orgFontSize = Number(el.dataset.visua11yAgentOrgFontSize) || parseInt(window.getComputedStyle(el).fontSize);
