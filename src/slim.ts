...
import visua11yAgent, { createVisua11yAgent, initVisua11yAgent, VERSION, version } from './index';
...
export { createVisua11yAgent, initVisua11yAgent, visua11yAgent, VERSION, version };
